...
for g in [120]: #range(65,125,5): 
    ...
    pd.DataFrame({"Monitored Location (um)":MonitoredLocations, "Spike Times":SpikeTimesToSave}).to_csv(f"SpikeTimes_gnabar_{gnabar_low}_a{axon.diam}_d1_{daughter1.diam}_d2_{daughter2.diam}_4B.csv", index = False, sep="\t")
